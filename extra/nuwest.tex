...
\setbeamercolor{normal text}{fg=IllinoisBlue}
\usetheme{default}
...
\setbeamercolor{frametitle}{bg=} % Set frame title to be transparent with black text
\setbeamercolor{frametitle}{fg=IllinoisOrange}
...
\setbeamertemplate{navigation symbols}{} % turn off navigation line (uncomment to reinstate)
...
\item View as 1 hour + 1 hour: feel free to try another session at the 1 hour mark!
\end{itemize}
\end{frame}
